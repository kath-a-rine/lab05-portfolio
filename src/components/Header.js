...
class Header extends Component {
  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block', backgroundImage:`./images/portfolio/caPoppies.jpg`
       }}>
        <a href="https://github.com/kath-a-rine" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
